...
1. Quản lý Sprints: Nhân

2. Các project không thường xuyên:
Gm1, Tank, Gm7, ... : Không có Sprint. Build khi làm xong

3. Các project thường xuyên
- Gm10 (Việt + Đạt): Sprint bắt đầu và kết thúc vào: thứ 2 mỗi tuần
- Craft (Mạnh): Sprint bắt đầu và kết thúc vào: thứ 3 mỗi tuần
- Tribe War (Stickwar 4) (anh Tài): Sprint bắt đầu và kết thúc vào: thứ 4 mỗi tuần
- Stick Dynasty (Stickwar 1) (anh Tài): Sprint bắt đầu và kết thúc vào: thứ 4 mỗi tuần
- Spiro (Hoàng + Sang): Sprint bắt đầu và kết thúc vào: thứ 5 mỗi tuần
- Goods Sort (Khoa): Sprint bắt đầu và kết thúc vào: thứ 6 mỗi tuần

4. Thời điểm build game và bàn giao cho QA:
